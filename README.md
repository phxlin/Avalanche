...
| Total remaining, progress, the projected debt-free date, and interest paid vs. still to come | Every debt as a card, revolving and installment tinted apart, tagged with where the extra goes and what is already paid this month | The debt-free date, then avalanche vs. snowball as tappable boxes with your extra per month    | Projected balance for both strategies plus your savings line, and a payoff timeline by payoff date | Balance and progress, interest paid so far (with an estimate), log a payment, projected payoff |
